...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        ...
        Args:
            width (l): The width of the Rectangle.
    ...
    def height(self):
        """
        Returns the widf the Rectangle
        """
    ...
    def height(self, value):
        ...
        Checks the parameters and set the size of the Rectangle
        Args:
            value (int): The heRectangle.
        Raises:
            TypeError: If `value` type is not `int`.
            ValueError: If `valuss than `0`.
        """
    ...
    def __str__(self):
        """
        Returns a strintation of the Rectangle.
        """
    ...
    def __repr__(self):
        """
        Returns the repre of the Rectangle.
        """
