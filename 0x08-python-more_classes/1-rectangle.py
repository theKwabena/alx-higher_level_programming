#!/usr/bin/python3
"""
A module wiRectangle that does nothing
"""
...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        ...
        Args:
            width (:obj:`idth of the Rectangle.
    ...
    def height(self, value):
        """
        Checks the pze of the Rectangle
        Args:
    ...
    def __check_positive_value(self, value):
        ...
        Args:
            value (imber to verify
        Returns:
            int: `True` If reater than
