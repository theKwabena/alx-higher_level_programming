...
class Rectangle:
    ...
    def height(self, value):
        """
        Checks the paramof the Rectangle
        Args:
    ...
    def __check_positive_value(self, value):
        """
        Checks if the valuepositive integer
        Args:
    ...
    def __draw_rectangle(self):
        ...
        Returns:
            ...
            otherwise a string with the Rectangle.
        """
    ...
    def __str__(self):
        """
        Returns a string with the representhe Rectangle.
        """
    ...
    def __repr__(self):
        """
        Returns thation of the Rectangle.
        """
