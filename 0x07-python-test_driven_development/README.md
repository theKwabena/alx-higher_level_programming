...
- How to wr
  ...
  * [101-lazy_matrix_mul.py](./101-lazy_matrix_mul.py): Python functions using the module `NumPy`.
  * Identical in function to [100-matrix_mul.py](./100-matrix_mul.py).

  * [102-python.c](./102-python.c): C function that prints basen developments.
